  ...
  return (
    <div className="flex flex-col items-center my-20">
      <span className="text-sm text-gray-700 dark:text-gray-400">
        Pages <span className="font-semibold text-gray-900 dark:text-white">{currentPage}</span> to{" "}
      ...
      <div className="inline-flex mt-2 xs:mt-0">
        <button
          ...
          style={{
            ...
            backgroundColor: isPrevBtnDisabled ? "#4b5563cf" : "",
          }}
          onClick={onClickPrev}
        >
          <svg
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: isNextBtnDisabled ? "#4b5563cf" : "",
          }}
          onClick={onClickNext}
        >
          Next
